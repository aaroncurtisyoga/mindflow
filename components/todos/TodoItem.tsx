...
export function TodoItem({ todo }: { todo: TodoItemType }) {
  ...
  return (
    <div
      className={cn(
        "group flex items-center gap-2 rounded-md px-2 py-2.5 transition-colors hover:bg-accent/50",
        todo.completed && "opacity-60"
      )}
      style={{ paddingLeft: `${(todo.depth * 24) + 8}px` }}
    >
      <div className="flex h-4 w-4 shrink-0 cursor-grab items-center justify-center text-muted-foreground/40 opacity-0 transition-opacity group-hover:opacity-100">
